...
`EmojiAIMaker/MT-CleanArchitecture/Domain/Entities/`

Never declare these in SwiftUI views, MVI containers, factories, services,
repositories, helpers, or `EmojiAIMaker/Exts`.
...
- After moving files, build through `EmojiAIMaker.xcworkspace`.
