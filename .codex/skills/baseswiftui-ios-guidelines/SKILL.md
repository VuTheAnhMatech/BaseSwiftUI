...
description: Use when creating, editing, polishing, or reviewing code for the BaseSwiftUI iOS project. This includes SwiftUI screens, Container/MVI flows, Factory dependency injection, Base component reuse, Asset/Color/Font management, or any project-specific architectural and UI rules.
---
...
* **App Entry**: `BaseSwiftUI/ContentView.swift` (Manages top-level routing: `SplashView -> MainTabbarView`).
